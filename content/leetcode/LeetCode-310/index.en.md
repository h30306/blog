...
Pattern: Topologicalstyle leaf trimming on an undirected tree Key insight: The root of a minimum height tree must be the center of the tree. A tree has either 1 or 2 centers. Approach: Build undirected adjacency sets and
