...
I reframe the smash process as partitioning stones into two groups. If the group sums are A and B, the final leftover is |A B|, so I want the two sums as close as possible. That means I only need subset sums up to total
