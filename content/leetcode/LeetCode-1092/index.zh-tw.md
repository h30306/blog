...
難易度: hard
第一次嘗試：2026-07-25
來源筆記：`notes/day41-week7-weekend-day1-shortest-common-supersequence-serializable-phantom-read.md`

## 解題思路

這篇整理 Shortest Common Supersequence 的解題筆記，重點放在 2D DP with reconstruction over two prefixes、狀態定義、轉移式與容易犯錯的地方。
