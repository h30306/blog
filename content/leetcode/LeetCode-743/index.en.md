...
I run Dijkstra from node k to compute the shortest signal arrival time to every node. If I cannot reach all nodes, I return 1. Otherwise I return the largest shortest arrival time, because that is when the last node rece
