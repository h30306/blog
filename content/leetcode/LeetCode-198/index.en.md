...
summary: "LeetCode Problem Solving - 1D DP / choose-skip recurrence"
...
For each house, I either skip it and keep the best result up to i 1, or rob it and add nums[i] to the best result up to i 2. The recurrence is a clean choosevsskip DP.
